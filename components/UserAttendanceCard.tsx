  ...
  return (
    <>
      <div
        ...
        className="flex items-center gap-3 p-3 bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-100 dark:border-zinc-800 shadow-sm active:scale-95 transition-all cursor-pointer hover:border-zinc-200 dark:hover:border-zinc-700 select-none touch-none"
      >
