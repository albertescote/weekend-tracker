      ...
      <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/70 backdrop-blur-md overflow-y-auto overflow-x-hidden">
        <div className="bg-white dark:bg-zinc-900 w-full max-w-sm rounded-[2.5rem] shadow-2xl overflow-hidden border border-zinc-100 dark:border-zinc-800 animate-in zoom-in-95 duration-200 my-auto max-h-[90vh] flex flex-col">
          ...
          <div className="p-6 flex items-center justify-between border-b border-zinc-50 dark:border-zinc-800 flex-shrink-0">
            <h3 className="font-black text-xl tracking-tight text-zinc-950 dark:text-white">El teu perfil</h3>
          ...
          <div className="overflow-y-auto flex-1 no-scrollbar">
            <form onSubmit={handleSubmit} className="p-8 space-y-8">
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-[10px] font-black text-zinc-400 uppercase tracking-widest text-center">Clica per canviar la foto</p>
              </div>

              <div className="space-y-4">
                {/* Email (Read Only) */}
                <div className="space-y-1">
                  <label className="text-[10px] font-black text-zinc-400 uppercase tracking-[0.2em] px-1">Correu electrònic</label>
                  <input
                    value={user.email}
                    readOnly
                ...
                {/* Full Name */}
                <div className="space-y-1">
                  <label className="text-[10px] font-black text-zinc-400 uppercase tracking-[0.2em] px-1">Nom d'usuari</label>
                  <input
                    value={fullName}
